...
module l1_dcache (
  ...
  localparam SRAM_NSETS = `KIANA_DCACHE_NSETS * `KIANA_DCACHE_NWAYS;
  ...
  stream_fifo_pipe_true #(
      .DATA_WIDTH(`KIANA_WIDBITS + `KIANA_DCACHE_SETIDXBITS + `KIANA_DCACHE_TAGBITS + `KIANA_DCACHE_NLANES + `KIANA_DCACHE_NLANES * `KIANA_DCACHE_BLOCKOFFSETBITS + `KIANA_DCACHE_NLANES * `KIANA_BYTESOFWORD + `KIANA_DCACHE_NLANES * `KIANA_XLEN + 7),
      .FIFO_DEPTH(1)
  ) core_req_q (
      .clk      (clk),
      .rst_n    (rst_n),
  ...
  assign core_req_tag_st1          = core_req_deq_bits[`KIANA_DCACHE_TAGBITS+`KIANA_DCACHE_NLANES+`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS+`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+6:`KIANA_DCACHE_NLANES+`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS+`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+7];
  assign core_req_activemask_st1   = core_req_deq_bits[`KIANA_DCACHE_NLANES+`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS+`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+6:`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS+`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+7];
  assign core_req_blockoffset_st1 = core_req_deq_bits[`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS+`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+6:`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+7];
  assign core_req_wordoffset1h_st1 = core_req_deq_bits[`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD+`KIANA_DCACHE_NLANES*`KIANA_XLEN+6:`KIANA_DCACHE_NLANES*`KIANA_XLEN+7];
  assign core_req_data_st1 = core_req_deq_bits[`KIANA_DCACHE_NLANES*`KIANA_XLEN+6:7];
  ...
  tag_access_top_v2 #(
      ...
      .NUM_WAY (`KIANA_DCACHE_NWAYS),
      .TAG_BITS(`KIANA_DCACHE_TAGBITS)
  ) tagaccess (
      .clk                             (clk),
      .rst_n                           (rst_n),
...
`endif
  ...
  always_comb begin
    ...
    end else if (memreq_arb_choose_bin[1]) begin
  ...
  genvar j, k;
  generate
    for (j = 0; j < `KIANA_DCACHE_BLOCKWORDS; j = j + 1) begin : LANE2BLOCK_B1
      assign write_miss_req_a_mask[`KIANA_BYTESOFWORD*(j+1)-1-:`KIANA_BYTESOFWORD] = wordoffset_conv[j];
      for (k = 0; k < `KIANA_DCACHE_NLANES; k = k + 1) begin : LANE2BLOCK_B2
        assign laneblock_conv[j][k]                                                     = ((core_req_blockoffset_st1[`KIANA_DCACHE_BLOCKOFFSETBITS*(k+1)-1-:`KIANA_DCACHE_BLOCKOFFSETBITS] == j) && core_req_activemask_st1[k]) ? 1'b1 : 1'b0;
        assign write_miss_req_a_data_remap[j][`KIANA_XLEN*(k+1)-1-:`KIANA_XLEN]         = laneblock_conv[j][k] ? core_req_st1_data_map_sameword[`KIANA_XLEN*(k+1)-1-:`KIANA_XLEN] : 'd0;
        assign wordoffset_conv_remap[j][`KIANA_BYTESOFWORD*(k+1)-1-:`KIANA_BYTESOFWORD] = laneblock_conv[j][k] ? core_req_st1_remap_wordoffset1h[`KIANA_BYTESOFWORD*(k+1)-1-:`KIANA_BYTESOFWORD] : 'd0;
      end
    end
  endgenerate
  ...
  genvar x, y, z;
  generate
    for (x = 0; x < `KIANA_DCACHE_BLOCKWORDS; x = x + 1) begin : DATA_BITCAT_B1
      for (y = 0; y < `KIANA_XLEN; y = y + 1) begin : DATA_BITCAT_B2
        for (z = 0; z < `KIANA_DCACHE_NLANES; z = z + 1) begin : DATA_BITCAT_B3
          assign write_miss_req_a_data_remap_bitcat[x][`KIANA_DCACHE_NLANES*y+z] = write_miss_req_a_data_remap[x][`KIANA_XLEN*z+y];
        end
      end
    end
  endgenerate
  ...
  genvar n, m;
  generate
    for (n = 0; n < `KIANA_DCACHE_BLOCKWORDS; n = n + 1) begin : DATA_OR_B1
      for (m = 0; m < `KIANA_XLEN; m = m + 1) begin : DATA_OR_B2
        assign write_miss_req_a_data[`KIANA_XLEN*n+m] = |write_miss_req_a_data_remap_bitcat[n][`KIANA_DCACHE_NLANES*(m+1)-1-:`KIANA_DCACHE_NLANES];
      end
    end
  endgenerate
  ...
  genvar a, b, c;
  generate
    for (a = 0; a < `KIANA_DCACHE_BLOCKWORDS; a = a + 1) begin : WORD_BITCAT_B1
      for (b = 0; b < `KIANA_BYTESOFWORD; b = b + 1) begin : WORD_BITCAT_B2
        for (c = 0; c < `KIANA_DCACHE_NLANES; c = c + 1) begin : WORD_BITCAT_B3
          assign wordoffset_conv_remap_bitcat[a][`KIANA_DCACHE_NLANES*b+c] = wordoffset_conv_remap[a][`KIANA_BYTESOFWORD*c+b];
        end
      end
    end
  endgenerate
  ...
  genvar p, q;
  generate
    for (p = 0; p < `KIANA_DCACHE_BLOCKWORDS; p = p + 1) begin : WORD_OR_B1
      for (q = 0; q < `KIANA_BYTESOFWORD; q = q + 1) begin : WORD_OR_B2
        assign wordoffset_conv[p][q] = |wordoffset_conv_remap_bitcat[p][`KIANA_DCACHE_NLANES*(q+1)-1-:`KIANA_DCACHE_NLANES];
      end
    end
  endgenerate
  ...
  assign write_miss_req_a_addr          = {core_req_tag_st1, core_req_setidx_st1, {(`KIANA_XLEN - `KIANA_BABITS) {1'b0}}};
  ...
  assign read_miss_req_a_addr           = {core_req_tag_st1, core_req_setidx_st1, {(`KIANA_XLEN - `KIANA_BABITS) {1'b0}}};
  assign read_miss_req_a_data           = 'd0;
  assign read_miss_req_a_mask           = {(`KIANA_DCACHE_BLOCKWORDS * `KIANA_BYTESOFWORD) {1'b1}};
  ...
  genvar e;
  generate
    for (e = 0; e < `KIANA_DCACHE_BLOCKWORDS; e = e + 1) begin : PERBANK_BLOCKIDX
      assign get_banken_perBankBlockIdx_v[e] = get_banken_perBankBlockIdx[$clog2(`KIANA_DCACHE_NLANES)*(e+1)-1-:$clog2(`KIANA_DCACHE_NLANES)];
    end
  endgenerate
  ...
  genvar f;
  generate
    for (f = 0; f < `KIANA_DCACHE_NLANES; f = f + 1) begin : DATA_REMAP
      assign core_req_st1_data_map_sameword_v[f]  = core_req_st1_data_map_sameword[`KIANA_XLEN*(f+1)-1-:`KIANA_XLEN];
      assign core_req_st1_remap_wordoffset1h_v[f] = core_req_st1_remap_wordoffset1h[`KIANA_BYTESOFWORD*(f+1)-1-:`KIANA_BYTESOFWORD];
    end
  endgenerate
  ...
  one2bin #(
      .ONE_WIDTH(`KIANA_DCACHE_NWAYS),
      .BIN_WIDTH($clog2(`KIANA_DCACHE_NWAYS))
  ) waymaskhit_oh2bin (
  ...
  assign mem_rsp_d_addr_st0   = mem_rsp_q_deq_bits[`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN-1-:`KIANA_XLEN];
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      end else if ((invalidate_no_dirty || flush_no_dirty) && waitfor_l2_flush) begin
        waitfor_l2_flush_st2 <= 1'b1;
      end
    end
  end
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      end else if (is_write_st0 && (mshr_mshr_status_st0 != 'd0)) begin
  ...
  dcache_wshr #(
      ...
      .WIDTH($clog2(`KIANA_DCACHE_WSHR_ENTRY))
  ) wshr_access (
      .clk                (clk),
      .rst_n              (rst_n),
  ...
  always_comb begin
    if (is_read_st1 || is_write_st1) begin
      ...
      end else if (is_read_st1) begin  //read miss
      ...
      end else begin  //write miss TODO: add hit in-flight miss
  ...
  assign invorflu_memreq_a_addr               = {tag_dirtyTag_st1, tag_dirtySetIdx_st1, {(`KIANA_XLEN - `KIANA_BABITS) {1'b0}}};
  assign invorflu_memreq_a_data               = data_access_rrsp;
  assign invorflu_memreq_a_mask               = {(`KIANA_DCACHE_BLOCKWORDS * `KIANA_BYTESOFWORD) {1'b1}};
  ...
  assign l2flush_memreq_a_addr                = {tag_dirtyTag_st1, tag_dirtySetIdx_st1, {(`KIANA_XLEN - `KIANA_BABITS) {1'b0}}};
  assign l2flush_memreq_a_data                = 'd0;
  assign l2flush_memreq_a_mask                = {(`KIANA_DCACHE_BLOCKWORDS * `KIANA_BYTESOFWORD) {1'b1}};
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      end else if (!tag_req_valid_ctrl && (mem_rsp_q_deq_valid && mem_rsp_q_deq_ready)) begin
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      end else if (tag_replace_status && memreq_arb_in0_ready) begin
  ...
  assign miss_rsp_ti_st1_blockoffset        = mshr_missrsp_out_targetinfo[`KIANA_TIWIDTH-`KIANA_WIDBITS-`KIANA_DCACHE_NLANES-1-:`KIANA_DCACHE_NLANES*`KIANA_DCACHE_BLOCKOFFSETBITS];
  assign miss_rsp_ti_st1_wordoffset1h       = mshr_missrsp_out_targetinfo[`KIANA_DCACHE_NLANES*`KIANA_BYTESOFWORD-1:0];
  ...
  assign tag_allocateWrite_setIdx           = mem_rsp_d_source_st0[`KIANA_DCACHE_SETIDXBITS-1:0];
  assign tag_allocateWriteData_st1          = mshr_missrsp_out_blockaddr[`KIANA_BABITS-1-:`KIANA_DCACHE_TAGBITS];
  ...
  assign mshr_missreq_targetinfo            = {mshr_miss_ti_st1_instrid, mshr_miss_ti_st1_activemask, mshr_miss_ti_st1_blockoffset, mshr_miss_ti_st1_wordoffset1h};
  ...
  assign mshr_missrsp_in_instrid            = mem_rsp_d_source_st0[`KIANA_DCACHE_SETIDXBITS+$clog2(`KIANA_DCACHE_MSHRENTRY)-1:`KIANA_DCACHE_SETIDXBITS];
  ...
  genvar i;
  generate
    for (i = 0; i < `KIANA_DCACHE_BLOCKWORDS; i = i + 1) begin : SRAM_REQ
      ...
      assign data_missrsp_sram_wreq_data[i]       = miss_replace_dirty_reg ? mem_rsp_d_data_st2[`KIANA_XLEN*(i+1)-1-:`KIANA_XLEN] : mem_rsp_d_data_st1[`KIANA_XLEN*(i+1)-1-:`KIANA_XLEN];
      assign data_missrsp_sram_wreq_waymask[i]    = {(`KIANA_DCACHE_BLOCKWORDS * `KIANA_BYTESOFWORD) {1'b1}};
      ...
      assign data_access_rrsp[`KIANA_XLEN*(i+1)-1-:`KIANA_XLEN] = data_access_r_resp_data[i];
  ...
  always_comb begin
    ...
    end else if (mshr_missrsp_out_valid) begin  //miss resp
      core_rsp_st2_enq_valid    = 1'b1;
      //core_rsp_st2_enq_data     = mem_rsp_d_data_st1;
      core_rsp_st2_enq_is_write = 1'b0;
    end else if (wait_mshr_core_rsp_st1 || flu_core_rsp_st1 || inv_core_rsp_st1) begin  //waitmshr, flush, invalidate resp
      core_rsp_st2_enq_valid    = 1'b1;
      //core_rsp_st2_enq_data     = 'd0 ;//DontCare
      core_rsp_st2_enq_is_write = 1'b0;
    end else if (read_hit_st2_valid && !core_rsp_q_enq_ready) begin  //hold ReadHit resp
      core_rsp_st2_enq_valid    = 1'b1;
  ...
  always_comb begin
    ...
    end else if (mshr_missrsp_out_valid) begin  //comes from mshr
  ...
  assign core_rsp_st2_enq_bits       = {core_rsp_st2_enq_is_write, core_rsp_st2_enq_instrid, core_rsp_st2_enq_data, core_rsp_st2_enq_activemask};

  assign core_rsp_st2_deq_is_write   = core_rsp_st2_deq_bits[`KIANA_WIDBITS+`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES];
  assign core_rsp_st2_deq_instrid    = core_rsp_st2_deq_bits[`KIANA_WIDBITS+`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES-1-:`KIANA_WIDBITS];
  assign core_rsp_st2_deq_data       = core_rsp_st2_deq_bits[`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES-1:`KIANA_DCACHE_NLANES];
  ...
  genvar d;
  generate
    for (d = 0; d < `KIANA_DCACHE_NLANES; d = d + 1) begin : MEM2CORE_ORDER
      assign mem2core_blockoffset_choose[d]                                = core_rsp_st2_blockoffset[`KIANA_DCACHE_BLOCKOFFSETBITS*(d+1)-1-:`KIANA_DCACHE_BLOCKOFFSETBITS];
      assign core_rsp_st2_data_coreorder[`KIANA_XLEN*(d+1)-1-:`KIANA_XLEN] = core_rsp_st2_data_memorder_forselect[mem2core_blockoffset_choose[d]];
    end
  endgenerate

  genvar g;
  generate
    for (g = 0; g < `KIANA_DCACHE_BLOCKWORDS; g = g + 1) begin : MEMORDER_S2V
      assign core_rsp_st2_data_memorder_forselect[g] = core_rsp_st2_data_memorder[`KIANA_XLEN*(g+1)-1-:`KIANA_XLEN];
    end
  endgenerate
  ...
  assign mem_req_q_enq_bits   = {memreq_arb_out_has_corersp, memreq_arb_out_corersp_instrid, memreq_arb_out_a_opcode, memreq_arb_out_a_param, memreq_arb_out_a_source, memreq_arb_out_a_addr, memreq_arb_out_a_data, memreq_arb_out_a_mask};
  ...
  stream_fifo_useSRAM_with_count #(
      .DATA_WIDTH(`KIANA_WIDBITS + $clog2(`KIANA_DCACHE_MSHRENTRY) + `KIANA_DCACHE_SETIDXBITS + `KIANA_XLEN + `KIANA_DCACHE_BLOCKWORDS * `KIANA_XLEN + `KIANA_DCACHE_BLOCKWORDS * `KIANA_BYTESOFWORD + 10),
      .FIFO_DEPTH(32)
  ) mem_req_q (
      .clk         (clk),
      .rst_n       (rst_n),
  ...
  assign mem_req_q_deq_a_opcode           = mem_req_q_deq_bits[$clog2(`KIANA_DCACHE_MSHRENTRY)+`KIANA_DCACHE_SETIDXBITS+`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD+8-:3];
  assign mem_req_q_deq_a_param            = mem_req_q_deq_bits[$clog2(`KIANA_DCACHE_MSHRENTRY)+`KIANA_DCACHE_SETIDXBITS+`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD+5-:3];
  assign mem_req_q_deq_a_source           = mem_req_q_deq_bits[$clog2(`KIANA_DCACHE_MSHRENTRY)+`KIANA_DCACHE_SETIDXBITS+`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD+2-:3+$clog2(`KIANA_DCACHE_MSHRENTRY)+`KIANA_DCACHE_SETIDXBITS];
  assign mem_req_q_deq_a_addr             = mem_req_q_deq_bits[`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD-1-:`KIANA_XLEN];
  assign mem_req_q_deq_a_data             = mem_req_q_deq_bits[`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN+`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD-1-:`KIANA_DCACHE_BLOCKWORDS*`KIANA_XLEN];
  assign mem_req_q_deq_a_mask             = mem_req_q_deq_bits[`KIANA_DCACHE_BLOCKWORDS*`KIANA_BYTESOFWORD-1:0];
  ...
  assign wshr_popReq_bits       = mem_rsp_d_source_st0[$clog2(`KIANA_DCACHE_WSHR_ENTRY)+`KIANA_DCACHE_SETIDXBITS-1:`KIANA_DCACHE_SETIDXBITS];  //ATTENTION: `KIANA_DCACHE_MSHRENTRY > `KIANA_DCACHE_WSHR_ENTRY
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      if (mem_req_is_write_st3 && mem_req_q_deq_valid && mem_req_q_deq_ready) begin
        mem_req_st3_a_source <= WM_ENTRY_EQUAL ? {3'b000, wshr_pushedIdx, mem_req_setidx_st2} : {3'b000, {(`KIANA_DCACHE_MSHRENTRY - `KIANA_DCACHE_WSHR_ENTRY) {1'b0}}, wshr_pushedIdx, mem_req_setidx_st2};
      end else if (wshr_pass && mem_req_q_deq_valid && mem_req_q_deq_ready) begin
  ...
  assign core_rsp_is_write_o   = core_rsp_q_deq_bits[`KIANA_WIDBITS+`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES];
  assign core_rsp_instrid_o    = core_rsp_q_deq_bits[`KIANA_WIDBITS+`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES-1-:`KIANA_WIDBITS];
  assign core_rsp_data_o       = core_rsp_q_deq_bits[`KIANA_DCACHE_NLANES*`KIANA_XLEN+`KIANA_DCACHE_NLANES-1:`KIANA_DCACHE_NLANES];
  assign core_rsp_activemask_o = core_rsp_q_deq_bits[`KIANA_DCACHE_NLANES-1:0];
