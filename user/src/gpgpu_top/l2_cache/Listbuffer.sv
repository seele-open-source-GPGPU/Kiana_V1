...
module Listbuffer(
  ...
  input logic [`KIANA_PUT_BITS-1:0]                         List_buffer_push_data_put_i   ,
  input logic [`KIANA_OP_BITS-1:0]                          List_buffer_push_data_opcode_i,
  input logic [`KIANA_SOURCE_BITS-1:0]                      List_buffer_push_data_source_i,
  ...
  output logic [`KIANA_PUT_BITS-1:0]                        List_buffer_data_put_o        ,
  output logic [`KIANA_OP_BITS-1:0]                         List_buffer_data_opcode_o     ,
  output logic [`KIANA_SOURCE_BITS-1:0]                     List_buffer_data_source_o         
  );
    ...
    begin
      if(!rst_n)
        ...
        begin
          ...
          data_source[freeIdx*`KIANA_SOURCE_BITS+:`KIANA_SOURCE_BITS] <= List_buffer_push_data_source_i;
          data_put   [freeIdx*`KIANA_PUT_BITS+:`KIANA_PUT_BITS] <= List_buffer_push_data_put_i;
          data_opcode[freeIdx*`KIANA_OP_BITS+:`KIANA_OP_BITS] <= List_buffer_push_data_opcode_i;
  ...
  assign List_buffer_data_opcode_o = data_opcode[pop_head*`KIANA_OP_BITS+:`KIANA_OP_BITS]        ;
  assign List_buffer_data_put_o    = data_put [pop_head*`KIANA_PUT_BITS+:`KIANA_PUT_BITS]        ;
  assign List_buffer_data_source_o = data_source[pop_head*`KIANA_SOURCE_BITS+:`KIANA_SOURCE_BITS];
